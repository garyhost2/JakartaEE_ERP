...
<body>
    ...
    <div class="card">
        ...
        <div class="error-messages" style="display: ${not empty validationErrors ? 'block' : 'none'}">

            <ul>

                <c:forEach var="violation" items="${validationErrors}">
        ...
        <form action="${pageContext.request.contextPath}/register" method="post">
            ...
            <div class="form-group">
                ...
                <input type="password" id="password" name="password" value="${user.password}" required autocomplete="new-password" />
    ...
    <script>
        ...
        document.addEventListener('mousemove', (e) => {
            ...
            stars.forEach((star, index) => {
                ...
                // Different movement factor for different stars creates parallax effect
                ...
                star.style.transform = `translate(${(mouseX - 0.5) * factor * 100}px, ${(mouseY - 0.5) * factor * 100}px)`;
